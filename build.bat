...
:build_clang
	...
	rem @note batch
	rem https://learn.microsoft.com/windows-server/administration/windows-commands/where
	rem https://learn.microsoft.com/windows-server/administration/windows-commands/start
	rem https://learn.microsoft.com/windows-server/administration/windows-commands/pause
	...
	rem https://learn.microsoft.com/cpp/build/reference/wx-treat-linker-warnings-as-errors
	rem https://learn.microsoft.com/cpp/c-runtime-library/crt-library-features
	rem https://learn.microsoft.com/cpp/build/reference/debug-generate-debug-info
	rem https://learn.microsoft.com/cpp/build/reference/subsystem-specify-subsystem
	rem https://learn.microsoft.com/cpp/build/reference/dll-build-a-dll
	rem https://learn.microsoft.com/cpp/build/reference/machine-specify-target-platform

	rem C compiler flags
	set cc=start /d "temp" /b clang -c
	set cc=%cc% -Wall -Wundef
	if "%WAE%" == "true" set cc=%cc% -Werror
	...
	if "%WAE%" == "true" set linkd=%linkd% -WX
	...
	(
		...
		%resc% "%project%/main.rc" -fo "main.res"
	) | pause > nul
